<x-layout title="Dashboard">
    ...
    @if (auth()->user()->can('add-agenda') || auth()->user()->can('add-event') || auth()->user()->can('add-survey'))
        <div class="fab fab-flower fab-bottom fab-end mb-12">
            <!-- a focusable div with tabindex is necessary to work on all browsers. role="button" is necessary for accessibility -->
            <div tabindex="0" role="button" class="btn btn-circle btn-lg btn-primary shadow-lg">
            ...
            <div class="fab-close">
                <span class="btn btn-circle btn-lg btn-error shadow-lg">✕</span>
            </div>
