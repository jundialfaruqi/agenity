            ...
            <div class="card bg-base-100 shadow-2xl border border-base-200 overflow-hidden">
                <div class="card-body p-10 md:p-16">
                    <div class="flex justify-center mb-8">
                        <div class="w-24 h-24 bg-success/10 text-success rounded-full flex items-center justify-center">
                    ...
                    <h1 class="text-3xl font-black mb-4">Terima Kasih!</h1>
                    <p class="text-lg text-base-content/70 leading-relaxed mb-10">
                        Kontribusi Anda sangat berharga bagi kami. Jawaban survei <strong>{{ $survey->title }}</strong> telah berhasil kami terima.
                    </p>
                        ...
                        <div class="flex gap-4">
                            ...
                            <div>
                                ...
                                <p class="text-sm text-base-content/60 leading-relaxed">
                                    Data Anda telah tersimpan dengan aman di sistem kami. Kami menggunakan informasi ini untuk meningkatkan kualitas layanan publik di lingkungan {{ $survey->opd->name }}.
                                </p>
                            </div>
                        </div>
                    </div>
