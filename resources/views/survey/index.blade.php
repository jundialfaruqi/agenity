                                ...
                                <td class="text-center">
                                    <div class="flex justify-center gap-1">
                                        ...
                                        @elseif($survey->visibility === 'public')
                                            <button type="button"
                                                class="btn btn-square btn-sm btn-ghost text-secondary tooltip"
                                                data-tip="Copy Public Link"
                                                onclick="copyText('{{ route('survey.public_detail', $survey->slug) }}', this)">
                                                <svg xmlns="http://www.w3.org/2000/svg" fill="none"
                                                    viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor"
                                                    class="w-4 h-4">
                                                    <path stroke-linecap="round" stroke-linejoin="round"
                                        ...
                                        @can('delete-survey')
                                            <button type="button"
                                                onclick="document.getElementById('delete_modal_{{ $survey->uuid }}').showModal()"
                                            ...
                                            <dialog id="delete_modal_{{ $survey->uuid }}" class="modal">
                                                <div class="modal-box">
