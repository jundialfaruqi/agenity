                ...
                <div class="grid grid-cols-1 md:grid-cols-3 gap-5">
                    <div x-data="{
                        ...
                        async init() {
                            ...
                            // Pre-fill if there is old input
                        ...
                        <div class="relative">
                            <button type="button" @click="toggleModal()"
                                class="flex items-center justify-between w-full px-4 py-3 bg-base-200 hover:bg-base-300 rounded-lg transition-colors border border-transparent"
                    ...
                    <div class="md:col-span-2">
                        ...
                        <textarea name="address" class="textarea textarea-bordered w-full min-h-14.5 leading-tight py-3" rows="1">{{ old('address') }}</textarea>
                        @error('address')
                            <div class="mt-1 text-xs text-error">{{ $message }}</div>
                        @enderror
                    </div>
