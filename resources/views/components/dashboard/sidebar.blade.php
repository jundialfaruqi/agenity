                ...
                @can('view-agenda')
                    <li>
                        <a wire:navigate href="{{ route('agenda.index') }}"
                            class="{{ request()->routeIs('agenda.*') ? 'active bg-base-200 text-base-content font-medium' : '' }}">
                            <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5"
                                stroke="currentColor" class="w-5 h-5">
                                <path stroke-linecap="round" stroke-linejoin="round"
                ...
                @can('view-survey')
                    <li>
                        <a wire:navigate href="{{ route('survey.index') }}"
                            class="{{ request()->routeIs('survey.*') ? 'active bg-base-200 text-base-content font-medium' : '' }}">
                            <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5"
